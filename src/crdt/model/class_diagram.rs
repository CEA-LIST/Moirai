...
record!(Feature {
    typ: VLog::<MVRegister::<PrimitiveType>>,
    visibility: VLog::<TORegister::<Visibility>>,
});

record!(Operation {
    is_abstract: VLog::<EWFlag>,
    visibility: VLog::<TORegister::<Visibility>>,
    parameters: UWMapLog::<String, VLog::<MVRegister::<TypeRef>>>,
    return_type: VLog::<MVRegister::<TypeRef>>,
});

record!(Class {
    is_abstract: VLog::<EWFlag>,
    name: VLog::<MVRegister::<String>>,
    features: UWMapLog::<String, FeatureLog>,
    operations: UWMapLog::<String, OperationLog>,
});

record!(Ends {
    source: VLog::<TORegister::<Multiplicity>>,
    target: VLog::<TORegister::<Multiplicity>>,
});

record!(Relation {
    ends: EndsLog,
    label: VLog::<MVRegister::<String>>,
    typ: VLog::<TORegister::<RelationType>>,
});
